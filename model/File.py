...
class File:
	...
	def __init__(self, file_md5, file_name, file_path, download_count):
	...
	def insert(self, conn: database.sqlite3.Connection) -> None:
		...
		Returns:
			None
		"""
		conn.execute('INSERT INTO files VALUES (?,?,?,?)', (self.file_md5, self.file_name, self.file_path, self.download_count))
